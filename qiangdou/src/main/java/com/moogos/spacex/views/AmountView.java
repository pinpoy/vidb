...
public class AmountView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    private int goods_storage = 5; //商品库存
    ...
    public void setInitCount(int amount) {
        this.amount = amount;
    ...
    public void onClick(View v) {
        if (!AppConfig.getConfig(getContext()).isVip()) {
            Toast.makeText(getContext(), "请升级VIP后使用此功能", Toast.LENGTH_SHORT).show();
            return;
        }
        int i = v.getId();
